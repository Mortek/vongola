<?php get_header(); ?>
	...
	<?php 
	   ...
	   <div id="blurb">
			...
			} ?>"><img class="basket" id="img-swap" src="<?php bloginfo('template_directory'); ?>/images/contact_off.png" alt="" /></a>
			
			<!-- Heeft u een website nodig of een verbetering aan uw huidige website? <br /> <br />
			Aarzel niet en neem contact op met Vongola! -->

			Als internetbureau creëren wij de mooiste en uiteraard gebruiksvriendelijke websites!<br />
			Neem eens een kijkje naar onze <a href="/diensten">diensten</a> en <a href="/projecten">projecten.</a>
	   ...
	   <!-- begin home boxes -->
		...
		<div id="homeBoxes" class="clearfix">
			<div class="homeBox">
				<h2><a href="<?php echo of_get_option('boldy_homebox1url')?>"><?php echo of_get_option('boldy_homebox1title')?></a></h2>
                ...
                <?php } ?>
				<p><?php echo of_get_option('boldy_homebox1')?> <!-- <a href="<?php //echo of_get_option('boldy_homebox1url')?>">Lees meer &raquo;</a> --></p>

			</div>
			<div class="homeBox">
				<h2><a href="<?php echo of_get_option('boldy_homebox2url')?>"><?php echo of_get_option('boldy_homebox2title')?></a></h2>
                ...
                <?php } ?>
				<p><?php echo of_get_option('boldy_homebox2')?> <!-- <a href="<?php //echo of_get_option('boldy_homebox2url')?>">Lees meer &raquo;</a> --></p>
			</div>
			<div class="homeBox last">
				<h2><a href="<?php echo of_get_option('boldy_homebox3url')?>"><?php echo of_get_option('boldy_homebox3title')?></a></h2>
                ...
                <?php } ?>
				<p><?php echo of_get_option('boldy_homebox3')?>  <!-- <a href="<?php //echo of_get_option('boldy_homebox3url')?>">Lees meer &raquo;</a> --></p>
			</div>
		</div>
		<?php }?>
		<!-- end home boxes -->
